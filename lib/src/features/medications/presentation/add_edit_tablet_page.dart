...
class AddEditTabletPage extends ConsumerStatefulWidget {
  const AddEditTabletPage({super.key});
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: const InputDecoration(
                            labelText: 'Strength *',
                            hintText: 'Enter strength per tablet',
                          ),
                          validator: (v) {
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          validator: (v) {
                            ...
                            if (d == null) return 'Enter a number';
                            if (d <= 0) return 'Must be > 0';
                            if (_stockUnit == StockUnit.tablets && !_isQuarter(d)) {
                              return 'Tablets must be in quarters (e.g., 0.25, 0.5, 0.75)';
                            }
                            return null;
                          },
                          onChanged: (_) => setState(() {}),
                      ...
                      Expanded(
                        child: DropdownButtonFormField<StockUnit>(
                          ...
                          items: const [
                            DropdownMenuItem(
                                value: StockUnit.tablets, child: Text('tablets')),
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
labelText: 'Lot / Storage Location',
