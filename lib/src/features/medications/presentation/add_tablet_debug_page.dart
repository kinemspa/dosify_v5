        ...
        child: Form(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(
              ...
              color: Colors.green,
              child: const Text('DEBUG: MINIMAL FORM BODY RENDERED',
            ...
            _section('General', [
              ...
              _rowLabelField(
                label: 'Manufacturer',
                field: TextFormField(controller: _manufacturerCtrl, textCapitalization: TextCapitalization.sentences, decoration: _dec(hint: 'e.g., GSK')),
              ),
              _rowLabelField(
                label: 'Description',
                field: TextFormField(controller: _descriptionCtrl, textCapitalization: TextCapitalization.sentences, decoration: _dec(hint: 'e.g., Pain relief')),
              ),
            ]),
            ...
            _section('Inventory', [
              _rowLabelField(
                label: 'Stock *',
                field: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Row(children: [
                    _incBtn('−', () {
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (v) {
                          ...
                          setState(() => _stockError = (d == null || _isQuarter(d)) ? null : 'Stock should be .00, .25, .50 or .75');
                        },
                      ),
                    ),
                    const SizedBox(width: 6),
            ...
            _section('Storage Information', [
              _rowLabelField(label: 'Batch No.', field: TextFormField(controller: _batchCtrl, textCapitalization: TextCapitalization.sentences, decoration: _dec(hint: 'Enter batch number'))),
              _rowLabelField(label: 'Lot / Storage Location', field: TextFormField(controller: _storageCtrl, textCapitalization: TextCapitalization.sentences, decoration: _dec(hint: 'Enter storage location'))),
              CheckboxListTile(
              ...
              _rowLabelField(label: 'Storage Instructions', field: TextFormField(controller: _storageNotesCtrl, textCapitalization: TextCapitalization.sentences, decoration: _dec(hint: 'Enter storage instructions'))),
            ]),
          ]),
        ),
      ),
                ...
                onPressed: _nameCtrl.text.trim().isNotEmpty ? () async {
                  ...
                  await showDialog(
                    ...
                    builder: (ctx) => AlertDialog(
                      ...
                      content: const Text('UI renders correctly. We will wire persistence next.'),
