      ...
      body: Form(
        ...
        child: MedEditorTemplate(
          appBarTitle: widget.initial == null
              ? 'Add Pre-Filled Syringe'
              : 'Edit Pre-Filled Syringe',
          summaryBuilder: (key) {
          ...
          nameField: Field36(
            child: TextFormField(
              ...
              decoration: buildFieldDecoration(context, hint: 'eg. MedX Rapid'),
          ...
          descriptionField: Field36(
            child: TextFormField(
              ...
              textCapitalization: TextCapitalization.sentences,
              style: Theme.of(context).textTheme.bodyMedium,
              decoration: buildFieldDecoration(context, hint: 'eg. Fast-acting formula'),
              onChanged: (_) => setState(() {}),
            ),
          ),
          notesField: Field36(
            child: TextFormField(
              ...
              textCapitalization: TextCapitalization.sentences,
              style: Theme.of(context).textTheme.bodyMedium,
              decoration: buildFieldDecoration(context, hint: 'eg. Inject before meals'),
              onChanged: (_) => setState(() {}),
            ),
          ),
