...
const double kFieldHeight = 36; // unified height for text fields and dropdowns (global standard)
...
const double kDropdownFontSize = 13; // selected item and menu item font size (compact)
...
TextStyle kMutedLabelStyle(BuildContext context) => Theme.of(context).textTheme.bodyMedium!
    .copyWith(color: Theme.of(context).colorScheme.onSurfaceVariant.withValues(alpha: 0.50));

// Checkbox label style: darker than support text but lighter than primary label
TextStyle kCheckboxLabelStyle(BuildContext context) => Theme.of(context).textTheme.bodyMedium!
    .copyWith(color: Theme.of(context).colorScheme.onSurfaceVariant.withValues(alpha: 0.85));

// Layout tweaks
const double kStrengthNudgeMinPx = 20; // minimum extra right nudge for Strength row
