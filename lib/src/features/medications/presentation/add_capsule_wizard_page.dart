...
class _AddCapsuleWizardPageState
  ...
  Widget buildSummaryContent() {
    ...
    final threshold = _lowStockEnabled
        ...
        : null;
    final headerTitle = name.isEmpty ? 'Capsule' : name;
        ...
        Row(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.medication_liquid, color: fg),
            ),
  ...
  Widget _buildStrengthStep() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Enter the active ingredient amount per capsule',
          style: mutedTextStyle(context),
        ),
        const SizedBox(height: 24),
        SectionFormCard(
          ...
          children: [
            ...
            buildHelperText(
              context,
              'Enter the active ingredient amount per capsule (usually printed on packaging)',
              fullWidth: true,
            ),
          ],
        ),
  ...
  Widget _buildInventoryStep() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Track your capsule inventory and set low stock alerts',
          style: mutedTextStyle(context),
        ),
        const SizedBox(height: 24),
        SectionFormCard(
          ...
          children: [
            ...
            buildHelperText(
              context,
              'Number of capsules you currently have',
              fullWidth: true,
            ),
            LabelFieldRow(
                  ...
                  onInc: () {
                    ...
                    if (newVal == stock && (v + 1) > stock) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Threshold cannot exceed current stock ($stock capsules)',
                          ),
            ...
            buildHelperText(
              context,
              _lowStockEnabled
                  ? 'Alert when capsules drop to this level'
