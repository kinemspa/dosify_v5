...
extension VialMedTypeConfig on VialMedType {
  MedicationForm get form => switch (this) {
    VialMedType.singleDoseVial => MedicationForm.singleDoseVial,
    VialMedType.prefilledSyringe => MedicationForm.prefilledSyringe,
  };

  StockUnit get stockUnit => switch (this) {
    VialMedType.singleDoseVial => StockUnit.singleDoseVials,
    VialMedType.prefilledSyringe => StockUnit.preFilledSyringes,
  };

  /// Lowercase singular noun, e.g. "vial" or "syringe".
  String get noun => switch (this) {
    VialMedType.singleDoseVial => 'vial',
    VialMedType.prefilledSyringe => 'syringe',
  };

  /// Lowercase plural noun, e.g. "vials" or "syringes".
  String get pluralNoun => switch (this) {
    VialMedType.singleDoseVial => 'vials',
...
class AddVialWizardPage extends MedicationWizardBase {
  ...
  @override
  ConsumerState<AddVialWizardPage> createState() => _AddVialWizardPageState();
}

class _AddVialWizardPageState
    extends MedicationWizardState<AddVialWizardPage> {
  VialMedType get _type => widget.vialMedType;
  ...
  Widget buildSummaryContent() {
    ...
    final threshold = _lowStockEnabled
        ...
        : null;
    final headerTitle = name.isEmpty ? _type.displayName : name;
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(text: ' ${_type.pluralNoun} in stock'),
                          ],
                        ),
                      ),
                    ),
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(text: ' ${_type.pluralNoun}'),
                          ],
                        ),
                      ),
                    ),
  ...
  Widget _buildConcentrationVolumeStep() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Enter the medication concentration and ${_type.noun} volume',
          style: mutedTextStyle(context),
        ),
        const SizedBox(height: 24),
        SectionFormCard(
          ...
          children: [
            ...
            buildHelperText(
              context,
              'Active ingredient amount per ${_type.noun}',
              fullWidth: true,
            ),
            LabelFieldRow(
              label: 'Volume *',
            ...
            buildHelperText(
              context,
              'Total volume in the ${_type.displayName}',
              fullWidth: true,
            ),
          ],
        ),
      ...
      children: [
        ...
        SectionFormCard(
          ...
          children: [
            ...
            buildHelperText(
              context,
              'Number of ${_type.displayName}s you currently have',
              fullWidth: true,
            ),
            LabelFieldRow(
                ...
                field: StepperRow36(
                  ...
                  onInc: () {
                    ...
                    if (newVal == stock && (v + 1) > stock) {
                      showAppSnackBar(
                        context,
                        'Threshold cannot exceed current stock ($stock ${_type.pluralNoun})',
            ...
            buildHelperText(
              context,
              _lowStockEnabled
                  ? 'Alert when ${_type.pluralNoun} drop to this level'
      ...
      children: [
        ...
        SectionFormCard(
          ...
          children: [
            ...
            buildHelperText(
              context,
              'When do the ${_type.pluralNoun} expire?',
              fullWidth: true,
            ),
            LabelFieldRow(
              label: 'Batch No.',
            ...
            buildHelperText(
              context,
              'Where you keep the ${_type.pluralNoun}',
              fullWidth: true,
            ),
            LabelFieldRow(
  ...
  Future<void> saveMedication() async {
    ...
    try {
      ...
      debugPrint('AddVialWizardPage(${_type.noun}): save failed: $e\n$stack');
      if (mounted) {
      ...
      children: [
        ...
        SectionFormCard(
          ...
          children: [
            ...
            _reviewRow('Type', _type.displayName),
        ...
        SectionFormCard(
          ...
          titleStyle: reviewCardTitleStyle(context),
          children: [
            _reviewRow('Current Stock', '${fmt2(stock)} ${_type.pluralNoun}'),
            _reviewRow(
              'Low Stock Alert',
              !_lowStockEnabled
                  ? 'Disabled'
                  : (threshold == null
                        ? 'Enabled'
                        : 'Enabled at ${fmt2(threshold)} ${_type.pluralNoun}'),
            ),
          ],
        ),
        const SizedBox(height: 12),
