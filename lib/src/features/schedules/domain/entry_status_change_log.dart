...
class EntryStatusChangeLog {
  const EntryStatusChangeLog({
    required this.id,
...
class EntryStatusChangeLogAdapter extends TypeAdapter<EntryStatusChangeLog> {
  @override
  int get typeId => 45;

  @override
  EntryStatusChangeLog read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, EntryStatusChangeLog obj) {
    writer
      ..writeByte(10)
      ..writeByte(0)
      ..write(obj.id)
