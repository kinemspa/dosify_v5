...
const allNavItems = <NavItemConfig>[
  ...
  NavItemConfig(id: 'medications', label: 'Medications', icon: Icons.medication, location: '/medications'),
  ...
  NavItemConfig(id: 'calendar', label: 'Calendar', icon: Icons.calendar_month, location: '/calendar'),
  NavItemConfig(id: 'reconstitution', label: 'Reconstitution', icon: Icons.science, location: '/medications/reconstitution'),
...
NavItemConfig? findNavItem(String id) =>
    allNavItems.firstWhere((e) => e.id == id, orElse: () => const NavItemConfig(id: 'home', label: 'Home', icon: Icons.home, location: '/'));
