  ...
  static InputDecoration decoration({
    ...
    switch (styleIndex) {
      ...
      case 1: // Outlined sharp
        return base.copyWith(border: const OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(4))));
      ...
      case 7: // Chip label above
        return base.copyWith(
          label: Container(
            ...
            child: Text(label, style: TextStyle(color: Theme.of(context).colorScheme.onSecondaryContainer, fontSize: 12)),
          ),
  ...
  static BoxDecoration sectionDecoration(BuildContext context, int styleIndex) {
    switch (styleIndex) {
      case 0: // filled tonal section
        return BoxDecoration(color: Colors.grey.shade50, borderRadius: BorderRadius.circular(12), border: Border.all(color: Colors.grey.shade200));
      case 1: // outlined sharp
        return BoxDecoration(borderRadius: BorderRadius.circular(6), border: Border.all(color: Theme.of(context).dividerColor));
      case 2: // underline minimal
        return const BoxDecoration();
      case 3: // elevated card
        return BoxDecoration(color: Theme.of(context).colorScheme.surface, borderRadius: BorderRadius.circular(12), boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.06), blurRadius: 6, offset: const Offset(0,2))]);
      case 4: // left accent
        return BoxDecoration(color: Theme.of(context).colorScheme.surface, borderRadius: BorderRadius.circular(12), border: Border(left: BorderSide(color: Theme.of(context).colorScheme.primary, width: 3)));
      case 5: // dense compact
        return BoxDecoration(borderRadius: BorderRadius.circular(8), border: Border.all(color: Colors.grey.shade300));
      case 6: // borderless + divider
        return const BoxDecoration();
      case 7: // chip header
        return BoxDecoration(color: Theme.of(context).colorScheme.surfaceContainer, borderRadius: BorderRadius.circular(12));
      case 8: // large header
        return BoxDecoration(color: Theme.of(context).colorScheme.surfaceContainerHighest, borderRadius: BorderRadius.circular(12));
      default: // monochrome minimal
        return BoxDecoration(color: Theme.of(context).colorScheme.surface, borderRadius: BorderRadius.circular(8), border: Border.all(color: Theme.of(context).colorScheme.outlineVariant));
    }
  }
}
