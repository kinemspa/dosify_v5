...
Skedux is purely a tracking app with medication metrics and records (for example: schedules, doses, dose logs, inventory, and vial/reconstitution tracking). It is intended for tracking approved medications only and does not endorse or facilitate use of unapproved substances.
